...
@CucumberOptions(
			features="Features/Mobile/MobileAutomation",
...
//		extentReportPath = extentReportPathFolder + "\\ExtentReports_" +  projectName + "_"+ReusableComponents.getCurrentDateAndTime() + ".html";
	...
	public void main_method(String scenarioName, String iteration, String executeFlag, String platform, String version,String deviceName) throws Throwable
	{ 
